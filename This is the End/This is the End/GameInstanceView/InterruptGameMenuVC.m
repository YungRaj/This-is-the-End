...
-(void)setUpInterruptGame
{
    ...
    switch(self.mode)
    {
        case InterruptedGameOver:
            interruptionText = (id)[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"gameover" ofType:@"png"]].CGImage;
        ...
        case InterruptedGamePaused:
            interruptionText = (id)[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"paused" ofType:@"png"]].CGImage;
