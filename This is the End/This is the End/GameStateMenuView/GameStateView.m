...
- (void)setUpSubViews
{
    ...
    id gameStateImage =
        (id)[UIImage
            imageWithContentsOfFile:[[NSBundle mainBundle]
                                        pathForResource:[NSString stringWithFormat:@"gamestate%d", self.data.state]
                                                 ofType:@"png"]]
            .CGImage;
    ...
    frame = CGRectMake(size.width / 25, size.height / 5, size.width / 4, size.height / 1.75);
    ...
    frame = CGRectMake(size.width * .8, size.height / 6, size.width / 6, size.height / 1.5);
    ...
    CGRect subframe =
        CGRectMake(subViewSize.width / 6, subViewSize.height / 6, subViewSize.width / 1.5, subViewSize.height / 1.5);

    [self.createGame setBackgroundImage:buttonImage forState:UIControlStateNormal];

    id createText =
        (id)[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"create" ofType:@"png"]].CGImage;

    id newText =
        (id)[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"new" ofType:@"png"]].CGImage;
    ...
    if (self.data.filePathExists) {
        id worldText =
            (id)[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"world" ofType:@"png"]]
                .CGImage;

        frame = CGRectMake(size.width * .38, size.height / 6, size.width / 10, size.height / 6);
        ...
        frame = CGRectMake(size.width * .5, size.height / 6, size.width / 50, size.height / 6);
        ...
        id worldBackground =
            (id)[UIImage imageWithContentsOfFile:[[NSBundle mainBundle]
                                                     pathForResource:[NSString stringWithFormat:@"background%d_thumb",
                                                                                                self.data.worlds]
                                                              ofType:@"png"]]
                .CGImage;

        frame = CGRectMake(size.width * .39, size.height / 2.25, size.width / 8, size.height / 2);
        ...
        frame = CGRectMake(size.width * .6, size.height / 6, size.width / 6, size.height / 1.5);
