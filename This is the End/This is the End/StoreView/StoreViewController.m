...
-(void)setUpPhoneView{
    ...
    [self.storeContents setContentSize:CGSizeMake(storeItemSize.width,
                                                  storeItemSize.height*(numberOfBadges+0.5))];
    ...
    for(int i=0; i<=numberOfBadges; i++){
        ...
        if(i==0){
            ...
            if(powerUpName){
                ...
                powerUpImage.contents = (id)[UIImage imageWithContentsOfFile:
                                             [[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"%@1",powerUpName] ofType:@"png"]].CGImage;
                powerUpImage.frame = CGRectMake(storeItemSize.width/6,
                                                storeItemSize.height/8,
                                                storeItemSize.width/6,
                                                storeItemSize.width/6);
            ...
            if(badgeName){
                ...
                badgeImage.contents = (id)[UIImage imageWithContentsOfFile:
                                             [[NSBundle mainBundle] pathForResource:badgeName ofType:@"png"]].CGImage;
                badgeImage.frame = CGRectMake(storeItemSize.width/6,
                                              storeItemSize.height/8,
                                              storeItemSize.width/6,
                                              storeItemSize.width/6);
